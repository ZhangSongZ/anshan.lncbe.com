define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'eow/eowbgd/index' + location.search,
                    add_url: 'eow/eowbgd/add',
                    edit_url: 'eow/eowbgd/edit',
                    del_url: 'eow/eowbgd/del',
                    multi_url: 'eow/eowbgd/multi',
                    import_url: 'eow/eowbgd/import',
                    table: 'exorder',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'eow/eowbgd/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
