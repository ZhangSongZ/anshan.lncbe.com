define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'datadictionary/hscode/index' + location.search,
                    add_url: 'datadictionary/hscode/add',
                    edit_url: 'datadictionary/hscode/edit',
                    del_url: 'datadictionary/hscode/del',
                    multi_url: 'datadictionary/hscode/multi',
                    import_url: 'datadictionary/hscode/import',
                    table: 'dic_hscode',
                }
            });
